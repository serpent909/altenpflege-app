...
const TOPICS_DE = {
  ...
  "Krankheitsbilder": {
    ...
    questions: [
      ...
      {
        q: "Was versteht man unter Inkontinenz-assoziierter Dermatitis (IAD) und wie wird sie behandelt?",
        a: "IAD entsteht durch anhaltende Feuchtigkeit und chemische Reizung durch Urin/Stuhl. Zeichen: Rötung, Mazeration, Schmerzen. Behandlung: Haut trocken halten, Barrierepflege (Zinkpaste, Hautschutzfilm), Inkontinenz konsequent versorgen.",
        options: ["Allergische Kontaktdermatitis durch Waschmittel; Pflegeprodukte wechseln und Kortisoncreme auftragen","Feuchtigkeitsbedingte Hautentzündung durch Inkontinenz; Barrierepflege, Hautschutzfilm, Inkontinenz versorgen","Sekundäre Pilzinfektion durch Candida; ausschließlich mit antimykotischer Creme zu behandeln","Druckgeschwür durch Reibung am Inkontinenzmaterial; Polsterung und 2-stündliche Umlagerung"],
        correct: 1,
        fillTemplate: "IAD entsteht durch ___ und chemische Reizung. Schutz durch ___ und Barrierecreme.",
        fillAnswers: ["Feuchtigkeit","Hautpflege"],
      },
      {
        q: "Wie behandelt man einen bestehenden Dekubitus und welche Wundversorgungsprinzipien gelten?",
        a: "Prinzip der feuchten Wundbehandlung: feuchtes Milieu fördert Heilung. Maßnahmen: Druckentlastung (wichtigste Maßnahme!), Wundreinigung, geeignete Wundauflage (Hydrokolloid, Alginat, Schaumstoff), Ernährung optimieren, Ursachen bekämpfen, dokumentieren.",
        options: ["Wunde täglich mit alkoholischer Lösung desinfizieren und trocken verbinden; Druckentlastung nur bei Grad 3","Druckentlastung, feuchte Wundauflage (Hydrokolloid/Alginat), Ernährungsoptimierung, Ursachenbekämpfung","Konservative Behandlung: täglich mit Kochsalz spülen und mit trockenem Mullverband abdecken","Wunde mit antiseptischer Salbe füllen und mit Pflaster abdecken; Verbandwechsel nur bei Durchfeuchtung"],
        correct: 1,
        fillTemplate: "Bei einem Dekubitus ist ___ die wichtigste Maßnahme. Die Wunde wird ___ behandelt (feuchtes Milieu).",
        fillAnswers: ["Druckentlastung","feucht"],
      },
      {
        q: "Welche Zeichen deuten auf eine Wundinfektion hin und was ist zu tun?",
        a: "Klassische Infektionszeichen: Rötung (Rubor), Wärme (Calor), Schwellung (Tumor), Schmerz (Dolor), Funktionseinschränkung. Zusätzlich: eitriges Sekret, schlechter Geruch, kein Heilungsfortschritt. Maßnahme: Arzt informieren, aseptische Wundversorgung.",
        options: ["Nur übelriechende Wunden sind infiziert; Rötungen ohne Sekret gehören zur normalen Wundheilung","Rötung, Wärme, Schwellung, Schmerz, eitriges Sekret; Arzt informieren, aseptische Versorgung","Wundinfektion zeigt sich ausschließlich durch Fieber und erhöhte Blutwerte, nicht lokal an der Wunde","Leichte Rötung am Wundrand ist normal und erfordert keine Meldung an den Arzt oder die Pflegeleitung"],
        correct: 1,
        fillTemplate: "Zeichen einer Wundinfektion: Rötung, ___, Schwellung und Schmerz. Bei Verdacht: ___ informieren.",
        fillAnswers: ["Wärme","Arzt"],
      },
      {
        q: "Was sind die vier Phasen der Wundheilung und welche Pflegemaßnahmen unterstützen sie?",
        a: "1. Exsudation/Reinigung (1–3 Tage): Wundreinigung, Nekrosen abtragen. 2. Granulation (3–21 Tage): feuchtes Milieu fördern. 3. Epithelisierung: Wunde schützen. 4. Narbenbildung. Pflege: feuchte Wundauflage, Druckentlastung, Ernährungsoptimierung.",
        options: ["Zwei Phasen: Entzündung und Abheilung; beide erfordern trockene Verbände zur Infektionsprävention","Exsudation, Granulation, Epithelisierung, Narbenbildung; feuchte Versorgung und Druckentlastung","Drei Phasen: Blutung, Schorfbildung, Vernarbung; Schorf sollte niemals entfernt werden","Wundheilung verläuft bei älteren Menschen in identischen Phasen wie bei jüngeren, nur minimal langsamer"],
        correct: 1,
        fillTemplate: "Die vier Wundheilungsphasen: ___, Granulation, ___ und Narbenbildung.",
        fillAnswers: ["Exsudation","Epithelisierung"],
      },
      {
        q: "Wie erkennt man Schmerzen bei kognitiv eingeschränkten oder nicht kommunikationsfähigen Bewohnern?",
        a: "Verhaltensbeobachtung: Grimassieren, Schonhaltung, Unruhe, Stöhnen, Abwehrreaktionen, veränderte Körperhaltung. Validierte Skalen: BESD (Beurteilung von Schmerzen bei Demenz), ZOPA. Regelmäßige strukturierte Einschätzung ist unerlässlich.",
        options: ["Schmerzen sind bei Demenzkranken nicht zuverlässig beurteilbar; Schmerztherapie sollte daher vermieden werden","Verhaltenszeichen: Grimassieren, Unruhe, Stöhnen; validierte Skalen wie BESD einsetzen","Selbstauskunft ist die einzige valide Methode; alle anderen Ansätze sind zu subjektiv","Schmerzen zeigen sich bei Demenz meist durch gesteigerte Aktivität und Euphorie, nicht durch Rückzug"],
        correct: 1,
        fillTemplate: "Schmerzen bei Demenz erkennt man an ___ wie Grimassieren und Stöhnen. Skala: ___ (Beurteilung von Schmerzen bei Demenz).",
        fillAnswers: ["Verhaltenszeichen","BESD"],
      },
      {
        q: "Was ist Osteoporose und welche Pflegekonsequenzen ergeben sich daraus?",
        a: "Osteoporose = Knochenschwund durch verminderte Knochendichte. Risiko: Frakturen bei geringen Traumata (Wirbelkörper, Hüfte, Handgelenk). Pflege: Sturzprophylaxe, sichere Umgebung, Mobilisation, Kalzium- und Vitamin-D-Gabe, Schmerzmanagement.",
        options: ["Gelenkdegeneration durch Knorpelabbau; Pflege: Wärmebehandlung, Gelenkschutz, kein Krafttraining","Knochenschwund mit erhöhtem Frakturrisiko; Pflege: Sturzprophylaxe, Kalzium, Vitamin D","Entzündliche Gelenkerkrankung durch Autoimmunprozess; Pflege: Medikamentenmanagement und Entlastung","Muskelabbau durch Proteinmangel; Pflege: eiweißreiche Ernährung und Kraftübungen dreimal wöchentlich"],
        correct: 1,
        fillTemplate: "Osteoporose ist ___ mit erhöhtem ___ Risiko. Sturzprophylaxe und Kalzium/Vitamin D sind zentrale Maßnahmen.",
        fillAnswers: ["Knochenschwund","Fraktur-"],
      },
      {
        q: "Welche typischen Hautprobleme haben bettlägerige Bewohner und wie werden sie verhindert?",
        a: "Häufig: Dekubitus (Druckschäden), Intertrigo (Pilzinfektion in Hautfalten), inkontinenzassoziierte Dermatitis (IAD), trockene Haut (Xerose). Prophylaxe: regelmäßige Hautinspektion, Umlagerung, Hautpflege, Feuchtigkeit meiden, Inkontinenz konsequent versorgen.",
        options: ["Bettlägerige Bewohner entwickeln vorwiegend allergische Reaktionen auf Pflegeprodukte","Dekubitus, Intertrigo, IAD, trockene Haut; Prophylaxe: Inspektion, Umlagerung, Hautpflege","Nur Dekubitus ist pflegerelevant; alle anderen Hautveränderungen werden ausschließlich ärztlich behandelt","Hautprobleme entstehen nur durch falsche Pflegeprodukte und sind durch Produktwechsel zu beheben"],
        correct: 1,
        fillTemplate: "Häufige Hautprobleme Bettlägeriger: Dekubitus, ___ und IAD. Vorbeugung: ___ und Hautpflege.",
        fillAnswers: ["Intertrigo","Umlagerung"],
      },
    ],
  },
  ...
  "Ernährung & Flüssigkeit": {
    ...
    questions: [
      ...
      {
        q: "Was ist stille (stumme) Aspiration und warum ist sie besonders gefährlich?",
        a: "Stille Aspiration = Einatmen von Speisen/Flüssigkeiten ohne Hustenreflex. Kein sichtbares Zeichen (kein Husten), deshalb oft unerkannt. Gefahr: Aspirationspneumonie. Risikofaktoren: Schlaganfall, Demenz, Parkinson. Regelmäßige Einschätzung durch Logopädie nötig.",
        options: ["Ein kurzer Hustenanfall während des Essens ohne Folgen; tritt bei jedem Menschen gelegentlich auf","Aspiration ohne Hustenreflex; gefährlich, da unerkannt; Risiko bei Schlaganfall, Demenz, Parkinson","Bewusstes Unterdrücken des Hustens beim Schlucken; kann durch gezieltes Training abgewöhnt werden","Einatmen von Luft beim Trinken; verursacht Blähungen, aber keine Aspirationspneumonie"],
        correct: 1,
        fillTemplate: "Stille Aspiration erfolgt ohne ___. Sie bleibt oft unerkannt und kann zur ___ führen.",
        fillAnswers: ["Hustenreflex","Aspirationspneumonie"],
      },
      {
        q: "Welche Sitzposition und Körperhaltung reduzieren das Aspirationsrisiko beim Essen?",
        a: "Oberkörper mindestens 90° aufrecht (senkrecht sitzen), Kopf leicht nach vorne geneigt (Kinn zur Brust). Beine auf dem Boden oder Fußstütze. Nach dem Essen mindestens 30 Minuten aufrecht bleiben.",
        options: ["Halbliegende Position (30°) mit zurückgelehntem Kopf; nach dem Essen sofort in Ruheposition bringen","Oberkörper 90° aufrecht, Kinn leicht zur Brust; 30 Minuten nach dem Essen aufrecht bleiben","Linksseitenlage, da die linke Magenseite tiefer liegt und Aspiration dadurch verhindert wird","Rückenlage mit erhöhtem Kopfkissen; Schwerkraft befördert Speisen nach unten und erleichtert Schlucken"],
        correct: 1,
        fillTemplate: "Zur Aspirationsvermeidung sollte der Oberkörper ___ aufrecht sitzen und der Kopf leicht nach ___ geneigt sein.",
        fillAnswers: ["90°","vorne"],
      },
      {
        q: "Was ist eine PEG-Sonde und welche Pflegeaufgaben gibt es dabei?",
        a: "PEG = perkutane endoskopische Gastrostomie; Ernährungssonde direkt in den Magen. Pflegeaufgaben: tägliche Einstichstellenpflege (auf Rötung, Sekret achten), Sonde auf Durchgängigkeit prüfen, Lage kontrollieren, Mund- und Lippenpflege, Lagerung bei Gabe.",
        options: ["Nasale Magensonde (NGT) zur kurzfristigen Ernährung für maximal 7 Tage","Magenernährungssonde; Pflege: Einstichstelle täglich kontrollieren, Durchgängigkeit prüfen, Mundpflege","Intravenöser Zugang für parenterale Ernährung; Pflege ausschließlich durch Pflegefachkraft","Duodenalkatheter bei schwerem Reflux; keine tägliche Pflege der Einstichstelle erforderlich"],
        correct: 1,
        fillTemplate: "PEG steht für perkutane endoskopische ___. Die Einstichstelle wird täglich auf ___ und Sekret kontrolliert.",
        fillAnswers: ["Gastrostomie","Rötung"],
      },
      {
        q: "Welche Kostformen gibt es bei Schluckstörungen und nach welchem System werden sie eingeteilt?",
        a: "International Dysphagia Diet Standardisation Initiative (IDDSI): Level 0–7. Von dünnflüssig (0) bis normal (7). Pflegerelevant: Level 4 (püriert), Level 5 (gewürfelt weich), Level 6 (weich). Flüssigkeiten: leicht bis stark eingedickt. Logopädie entscheidet.",
        options: ["Nur zwei Stufen: Vollkost und Püriert; die Pflegeleitung entscheidet täglich nach Beobachtung","IDDSI Level 0–7: von dünnflüssig bis normal; püriert, weich, gewürfelt weich je nach Schluckvermögen","Kostform wird nach Kaloriengehalt gewählt; Schluckfähigkeit ist nur eine nachrangige Überlegung","Drei Stufen: flüssig, breiig, fest; die Stufe bleibt dauerhaft unverändert bis zur Entlassung"],
        correct: 1,
        fillTemplate: "Kostformen bei Schluckstörungen richten sich nach dem ___ (Level 0–7). Die Entscheidung trifft die ___.",
        fillAnswers: ["IDDSI","Logopädie"],
      },
      {
        q: "Was versteht man unter einem Ernährungsscreening und welches Instrument ist in der Altenpflege verbreitet?",
        a: "Ernährungsscreening = systematische Erfassung des Mangelernährungsrisikos bei Aufnahme und regelmäßig danach. Verbreitetes Instrument: MNA (Mini Nutritional Assessment) – erfasst BMI, Gewichtsverlust, Mobilität, Nahrungsaufnahme, Selbsteinschätzung. Bei Risiko: Ernährungsplan erstellen.",
        options: ["Einmalige Gewichtsmessung bei Aufnahme; Folgemessungen nur bei sichtbarem Gewichtsverlust","Systematische Mangelernährungsrisikoerfassung; MNA bei Aufnahme und regelmäßig, Ernährungsplan bei Risiko","Ärztlich angeordnetes Blutbild zur Feststellung von Albumin- und Vitaminmangel","Tägliches Kalorienprotokoll durch Pflegepersonal; validierte Instrumente sind nicht erforderlich"],
        correct: 1,
        fillTemplate: "Ernährungsscreening erfasst ___ mit dem ___. Bei Risiko wird ein Ernährungsplan erstellt.",
        fillAnswers: ["Mangelernährungsrisiko","MNA"],
      },
      {
        q: "Welche Hilfsmittel erleichtern das selbstständige Essen und Trinken bei eingeschränkter Handfunktion?",
        a: "Angepasstes Besteck (Griffverdicker, gebogener Löffel), rutschfeste Unterlagen, Teller mit erhöhtem Rand, Schnabeltasse oder Strohhalm, Gläser mit zwei Griffen, Schneidehilfen. Ziel: Selbstständigkeit erhalten (aktivierende Pflege).",
        options: ["Vollständige Übernahme der Nahrungsaufnahme; Hilfsmittel sind bei eingeschränkter Handfunktion unzuverlässig","Griffverdicker, Teller mit erhöhtem Rand, rutschfeste Unterlage, Schnabeltasse; Selbstständigkeit fördern","Ausschließlich pürierte Kost, die ohne Besteck direkt aus der Schüssel getrunken werden kann","Elektrisch höhenverstellbare Tische; andere Hilfsmittel haben keinen Einfluss auf die Selbstständigkeit"],
        correct: 1,
        fillTemplate: "Hilfsmittel wie ___ und rutschfeste Unterlagen fördern die ___ beim Essen.",
        fillAnswers: ["Griffverdicker","Selbstständigkeit"],
      },
    ],
  },
  ...
  "Prophylaxen": {
    ...
    questions: [
      ...
      {
        q: "Was ist die Aspirationsprophylaxe und welche Maßnahmen gehören dazu?",
        a: "Aspirationsprophylaxe = Schutz vor dem Einatmen von Speisen/Flüssigkeiten. Maßnahmen: aufrechte Körperposition beim Essen, Kostanpassung (Eindicken), kleine Bissen, langsames Essen, Mundhygiene, Schluckkontrolle, Logopädie bei Schluckstörungen.",
        options: ["Ausschließlich Magenspülung und Absaugen nach einer Aspiration","Aufrechte Position, angepasste Kost, kleine Bissen, langsames Essen, Mundhygiene, Logopädie","Magensäure senken durch Antazida; verhindert Aspirationspneumonie bei gastroösophagealem Reflux","Schnelles Anreichen und sofortige Umstellung auf Flüssigkost; reduziert Verweildauer im Mund"],
        correct: 1,
        fillTemplate: "Aspirationsprophylaxe: ___ Position beim Essen, ___ Kost und kleine Bissen.",
        fillAnswers: ["aufrechte","angepasste"],
      },
      {
        q: "Was ist die Obstipationsprophylaxe und welche Maßnahmen sind wirksam?",
        a: "Obstipationsprophylaxe = Vorbeugung von Verstopfung. Maßnahmen: ausreichend Flüssigkeit (mind. 1,5–2 l/Tag), ballaststoffreiche Kost (Obst, Gemüse, Vollkorn), Mobilisation, Bauchmassage, regelmäßige Toilettenzeiten, Intimsphäre wahren.",
        options: ["Laxantien täglich als Standardmaßnahme; nicht-medikamentöse Maßnahmen sind wenig wirksam","Flüssigkeit, Ballaststoffe, Mobilisation, Bauchmassage, regelmäßige Toilettenzeiten","Obstipation ist ein normaler Alterungsprozess; prophylaktische Maßnahmen sind nicht evidenzbasiert","Nur Diätmaßnahmen; Bewegung und Massage haben keinen nachgewiesenen Einfluss auf die Darmtätigkeit"],
        correct: 1,
        fillTemplate: "Obstipationsprophylaxe: viel ___, ballaststoffreiche Kost und regelmäßige ___.",
        fillAnswers: ["Flüssigkeit","Mobilisation"],
      },
      {
        q: "Was ist Intertrigo und wie unterscheidet sich die Prophylaxe von der Dekubitusprophylaxe?",
        a: "Intertrigo = Entzündung in Hautfalten durch Reibung und Feuchtigkeit (Pilze, Bakterien). Gefährdete Stellen: Leistenbeuge, Analfalte, unter Brust, zwischen Zehen. Prophylaxe: Hautfalten täglich trockenhalten, Barrierecreme/Einpudern, Hautinspektion – kein Druckentlastungsfokus wie beim Dekubitus.",
        options: ["Druckbedingte Hautrötung an Knochenvorsprüngen; Prophylaxe durch Umlagerung wie beim Dekubitus","Hautfalteentzündung durch Feuchtigkeit; trockenhalten, Barrierecreme, tägliche Inspektion","Pilzinfektion ausschließlich der Mundschleimhaut; Prophylaxe durch antifungale Mundspülung","Nagelbettentzündung; Prophylaxe durch regelmäßige Nagelkürzung und tägliche Fußbäder"],
        correct: 1,
        fillTemplate: "Intertrigo entsteht in ___ durch Feuchtigkeit. Prophylaxe: trockenhalten und ___.",
        fillAnswers: ["Hautfalten","Barrierecreme"],
      },
      {
        q: "Was ist Mikrolagerung und wie unterstützt sie die Dekubitusprophylaxe?",
        a: "Mikrolagerung = kleine Positionsveränderungen (5–30°) zur Druckverteilung ohne vollständiges Wenden. Bevorzugte Position: 30°-Schräglage. Ergänzt Standardumlagerung alle 2 Stunden. Kombiniert mit druckentlastenden Hilfsmitteln. Jede Lagerung dokumentieren.",
        options: ["Vollständiges Wenden von Rücken- in Bauchlage alle 2 Stunden; Mikrolagerung ist keine anerkannte Methode","Kleine Positionsveränderungen (5–30°); 30°-Schräglage bevorzugt; kombiniert mit Hilfsmitteln","Ausschließlich Rückenlagerung auf Spezialmatratze; Seitenlagerung erhöht Dekubitusrisiko","Stufenloses Hochstellen des Bettes; Körperposition ist bei Spezialmatratze irrelevant"],
        correct: 1,
        fillTemplate: "Mikrolagerung = Positionsveränderungen von ___°. Die ___-Schräglage ist bevorzugt.",
        fillAnswers: ["5–30","30°"],
      },
      {
        q: "Welche Hautpflegeprodukte und -methoden werden in der Dekubitusprophylaxe eingesetzt?",
        a: "Regelmäßige Hautinspektion auf Rötungen über Knochenvorsprüngen. Trockene Haut: Wasser-in-Öl-Emulsionen. Feuchte Haut (Schweiß, Inkontinenz): Barrierecreme. Keine alkoholhaltigen Produkte. Einreiben/Massieren von geröteten Stellen ist kontraindiziert.",
        options: ["Alkoholhaltige Lotion für Knochenvorsprünge; tötet Bakterien und härtet die Haut ab","Hautinspektion, Wasser-in-Öl-Emulsion für trockene Haut, Barrierecreme bei Feuchtigkeit; kein Einreiben","Tägliche Einreibemassage aller Knochenvorsprünge mit Franzbranntwein zur Durchblutungsförderung","Beliebige Körperlotion; Produktwahl hat keinen Einfluss auf das Dekubitusrisiko"],
        correct: 1,
        fillTemplate: "Gefährdete trockene Haut: ___ Emulsion verwenden. Gerötete Stellen dürfen ___ werden.",
        fillAnswers: ["Wasser-in-Öl","nicht massiert"],
      },
      {
        q: "Was ist Kontrakturprophylaxe durch Lagerung und welche Hilfsmittel werden eingesetzt?",
        a: "Ziel: Gelenke in Funktionsstellung halten, Spitzfuß und Beugefehlstellungen verhindern. Hilfsmittel: Lagerungsrollen, Positionierungskissen, Spitzfußorthese, weiche Einlagen für Handballen. Passivbewegungen ergänzen die Lagerung.",
        options: ["Gelenke in maximaler Streckstellung lagern; Beugung bei bettlägerigen Patienten immer verhindern","Funktionsstellung halten; Lagerungsrollen, Kissen, Spitzfußorthese, Passivbewegungen ergänzen","Ausschließlich Weichlagerung zur Schmerzreduktion; Gelenkstellung ist sekundär gegenüber dem Komfort","Alle Extremitäten hoch lagern; verhindert Ödeme und Kontrakturen gleichzeitig"],
        correct: 1,
        fillTemplate: "Ziel der Kontrakturlagerung: Gelenke in ___ halten. Hilfsmittel: ___ und Positionierungskissen.",
        fillAnswers: ["Funktionsstellung","Lagerungsrollen"],
      },
      {
        q: "Was ist die Inkontinenzprophylaxe und welche Maßnahmen erhalten die Kontinenz?",
        a: "Kontinenzförderung statt reiner Inkontinenzversorgung. Maßnahmen: regelmäßige Toilettenangebote (Toilettentraining), Blasentagebuch, ausreichend Flüssigkeit (nicht einschränken!), Beckenbodenübungen, barrierearme Toilette, diskrete Versorgung mit Intimsphäre.",
        options: ["Flüssigkeitsrestriktion und tägliches Einmalkatheterisieren; Inkontinenzmaterial als einzige Maßnahme","Regelmäßige Toilettenangebote, Blasentagebuch, Beckenbodenübungen, ausreichend Flüssigkeit","Inkontinenz ist irreversibel; prophylaktische Maßnahmen haben keinen Einfluss auf die Blasenfunktion","Dauerkatheter zur Inkontinenzvermeidung; verhindert Hautprobleme und erleichtert die Pflege"],
        correct: 1,
        fillTemplate: "Inkontinenzprophylaxe: regelmäßige ___ und ausreichend ___. Flüssigkeit sollte nie eingeschränkt werden.",
        fillAnswers: ["Toilettenangebote","Flüssigkeit"],
      },
    ],
  },
...
const TOPICS_EN = {
  ...
  "Common Conditions": {
    ...
    questions: [
      ...
      {
        q: "What is incontinence-associated dermatitis (IAD) and how is it treated?",
        a: "IAD arises from prolonged moisture and chemical irritation from urine and stool. Signs: redness, maceration, pain. Treatment: keep skin dry, barrier care (zinc paste, skin protective film), consistently manage incontinence.",
        options: ["An allergic contact dermatitis caused by detergents; change care products and apply hydrocortisone cream","Moisture-related skin inflammation from incontinence; barrier care, skin protective film, manage incontinence","A secondary fungal infection caused by Candida; treated exclusively with antifungal cream","A pressure injury from friction against incontinence material; padding and 2-hourly repositioning"],
        correct: 1,
        fillTemplate: "IAD arises from ___ and chemical irritation. Protection through ___ and barrier cream.",
        fillAnswers: ["moisture","skin care"],
      },
      {
        q: "How is an existing pressure ulcer treated and what wound care principles apply?",
        a: "Moist wound treatment principle: moist environment promotes healing. Measures: pressure relief (most important!), wound cleansing, suitable dressing (hydrocolloid, alginate, foam), optimise nutrition, address causes, document.",
        options: ["Disinfect daily with alcohol solution and apply a dry dressing; pressure relief only for grade 3","Pressure relief, moist wound dressing (hydrocolloid/alginate), nutritional optimisation, address causes","Conservative treatment: flush daily with saline and cover with dry gauze dressings","Fill wound with antiseptic ointment and cover with a plaster; change dressing only when soaked"],
        correct: 1,
        fillTemplate: "For a pressure ulcer, ___ is the most important measure. Wounds are treated ___ (moist environment).",
        fillAnswers: ["pressure relief","moist"],
      },
      {
        q: "What signs indicate a wound infection and what action should be taken?",
        a: "Classic infection signs: redness (rubor), warmth (calor), swelling (tumor), pain (dolor), functional impairment. Also: purulent discharge, bad odour, no healing progress. Action: inform the doctor, aseptic wound care.",
        options: ["Only malodorous wounds are infected; redness without discharge is part of normal healing","Redness, warmth, swelling, pain, purulent discharge; inform doctor, aseptic wound care","Wound infection shows exclusively as fever and elevated blood counts, not as local wound changes","Mild redness at the wound margin is normal healing and does not need to be reported"],
        correct: 1,
        fillTemplate: "Signs of wound infection: redness, ___, swelling and pain. If suspected: inform the ___.",
        fillAnswers: ["warmth","doctor"],
      },
      {
        q: "What are the four phases of wound healing and which nursing measures support them?",
        a: "1. Exudation/cleansing (1–3 days): wound cleansing, remove necrosis. 2. Granulation (3–21 days): promote moist environment. 3. Epithelialisation: protect wound. 4. Scar formation. Care: moist dressing, pressure relief, nutritional optimisation.",
        options: ["Two phases: inflammation and resolution; both require dry dressings to prevent infection","Exudation, granulation, epithelialisation, scar formation; moist care and pressure relief","Three phases: bleeding, scab formation, scarring; the scab should never be removed","Wound healing follows identical phases in older people as in younger adults, only marginally slower"],
        correct: 1,
        fillTemplate: "The four wound healing phases: ___, granulation, ___ and scar formation.",
        fillAnswers: ["exudation","epithelialisation"],
      },
      {
        q: "How are pain signs recognised in cognitively impaired or non-verbal residents?",
        a: "Behavioural observation: grimacing, guarding posture, restlessness, moaning, defensive reactions, changed body posture. Validated scales: PAINAD, BESD, ZOPA. Regular structured assessment is essential.",
        options: ["Pain cannot be reliably assessed in people with dementia; pain therapy should therefore be avoided","Behavioural signs: grimacing, restlessness, moaning; use validated scales such as PAINAD or BESD","Self-report is the only valid method; all other approaches are too subjective for clinical use","In dementia, pain typically presents as euphoria and increased activity, not as withdrawal or guarding"],
        correct: 1,
        fillTemplate: "Pain in dementia is recognised through ___ such as grimacing. A validated scale like ___ should be used.",
        fillAnswers: ["behavioural signs","PAINAD"],
      },
      {
        q: "What is osteoporosis and what care consequences does it have?",
        a: "Osteoporosis = loss of bone density. Risk: fractures from minimal trauma (vertebrae, hip, wrist). Care: falls prophylaxis, safe environment, mobilisation, calcium and vitamin D supplementation, pain management.",
        options: ["Joint degeneration from cartilage loss; care: heat treatment, joint protection, no resistance training","Bone density loss with increased fracture risk; care: falls prophylaxis, calcium, vitamin D","Inflammatory joint disease from autoimmune process; care: medication management and joint offloading","Muscle wasting from protein deficiency; care: high-protein diet and strength exercises three times weekly"],
        correct: 1,
        fillTemplate: "Osteoporosis is ___ with increased ___ risk. Falls prophylaxis and calcium/vitamin D are key measures.",
        fillAnswers: ["bone density loss","fracture"],
      },
      {
        q: "What are typical skin problems in bedridden residents and how are they prevented?",
        a: "Common: pressure ulcers (pressure damage), intertrigo (infection in skin folds), incontinence-associated dermatitis (IAD), dry skin (xerosis). Prevention: regular skin inspection, repositioning, skin care, avoid moisture, consistently manage incontinence.",
        options: ["Bedridden residents mainly develop allergic reactions to care products","Pressure ulcers, intertrigo, IAD, dry skin; prevention: inspection, repositioning, skin care","Only pressure ulcers are nursing-relevant; all other skin changes are managed exclusively by physicians","Skin problems are caused only by incorrect care products and can be prevented by changing them"],
        correct: 1,
        fillTemplate: "Common skin problems in bedridden residents: pressure ulcers, ___ and IAD. Prevention: ___ and skin care.",
        fillAnswers: ["intertrigo","repositioning"],
      },
    ],
  },
  ...
  "Nutrition & Fluids": {
    ...
    questions: [
      ...
      {
        q: "What is silent aspiration and why is it particularly dangerous?",
        a: "Silent aspiration = inhalation of food or fluid without a cough reflex. No visible sign (no cough), therefore often undetected. Risk: aspiration pneumonia. Risk factors: stroke, dementia, Parkinson's disease. Regular assessment by speech therapy is needed.",
        options: ["A brief coughing episode during eating with no consequences; occurs occasionally in everyone","Aspiration without a cough reflex; dangerous as it goes undetected; risk in stroke, dementia, Parkinson's","Deliberate suppression of coughing while swallowing; can be unlearned with practice","Inhalation of air while drinking; causes bloating but does not lead to aspiration pneumonia"],
        correct: 1,
        fillTemplate: "Silent aspiration occurs without a ___ reflex. It often goes undetected and can lead to ___.",
        fillAnswers: ["cough","aspiration pneumonia"],
      },
      {
        q: "Which seating position and body posture reduce aspiration risk during eating?",
        a: "Upper body at least 90° upright (sitting straight), head slightly tilted forward (chin towards chest). Feet flat on floor or footrest. Remain upright for at least 30 minutes after eating.",
        options: ["Semi-reclined position (30°) with head tilted back; move into rest position immediately after eating","Upper body 90° upright, chin slightly towards chest; remain upright for 30 minutes after eating","Left lateral position, as the left side of the stomach is lower and therefore prevents aspiration","Supine position with an elevated pillow; food passes more easily when following gravity downward"],
        correct: 1,
        fillTemplate: "To reduce aspiration risk, the upper body should be ___ upright and the head tilted slightly ___.",
        fillAnswers: ["90°","forward"],
      },
      {
        q: "What is a PEG tube and what nursing tasks are involved?",
        a: "PEG = percutaneous endoscopic gastrostomy; feeding tube placed directly into the stomach. Nursing tasks: daily stoma site care (check for redness and discharge), check tube patency, check position, oral and lip care, correct positioning during feeding.",
        options: ["A nasal feeding catheter (nasogastric tube) for short-term nutrition for a maximum of 7 days","Gastric feeding tube; care: check stoma site daily for redness, check patency, oral care","An intravenous access for parenteral nutrition; care performed exclusively by registered nurses","A duodenal catheter for feeding in severe reflux; no daily stoma site care is required"],
        correct: 1,
        fillTemplate: "PEG stands for percutaneous endoscopic ___. The stoma site is checked daily for ___ and discharge.",
        fillAnswers: ["gastrostomy","redness"],
      },
      {
        q: "What texture levels exist for people with swallowing difficulties and which system is used?",
        a: "International Dysphagia Diet Standardisation Initiative (IDDSI): Levels 0–7. From thin (0) to regular (7). Care-relevant: Level 4 (pureed), Level 5 (minced and moist), Level 6 (soft and bite-sized). Fluids: slightly to extremely thick. Speech therapy decides.",
        options: ["Only two levels: full diet and pureed; the care team leader decides daily based on observation","IDDSI Levels 0–7: from thin to regular; pureed, soft, minced depending on swallowing ability","Texture levels are chosen by caloric content; swallowing ability is only a secondary consideration","Three levels: liquid, soft, solid; the texture level remains permanently unchanged until discharge"],
        correct: 1,
        fillTemplate: "Texture levels follow the ___ (Levels 0–7). The level is decided by ___.",
        fillAnswers: ["IDDSI","speech therapy"],
      },
      {
        q: "What is nutritional screening and which tool is commonly used in elderly care?",
        a: "Nutritional screening = systematic identification of malnutrition risk on admission and regularly thereafter. Common tool: MNA (Mini Nutritional Assessment) – captures BMI, weight loss, mobility, food intake, self-assessment. If at risk: create a nutrition plan.",
        options: ["A single weight measurement on admission; follow-up only if visible weight loss occurs","Systematic malnutrition risk assessment; MNA on admission and regularly, nutrition plan if at risk","A physician-ordered blood panel to detect albumin and vitamin deficiency","Daily calorie records kept by care staff; no validated tools are needed"],
        correct: 1,
        fillTemplate: "Nutritional screening identifies ___ risk using the ___. A nutrition plan is created if at risk.",
        fillAnswers: ["malnutrition","MNA"],
      },
      {
        q: "What aids help residents eat and drink independently when hand function is impaired?",
        a: "Adapted cutlery (thickened handles, angled spoon), non-slip mats, plates with raised edges, spouted cups or straws, two-handled glasses, cutting aids. Goal: maintain independence (activating care approach).",
        options: ["Full assistance with feeding; adapted aids are unreliable when hand function is significantly impaired","Thickened handles, raised plate edges, non-slip mat, spouted cup; promote independence","Exclusively pureed food that can be consumed directly from a bowl without any cutlery","Electrically height-adjustable tables; all other aids have no influence on eating independence"],
        correct: 1,
        fillTemplate: "Aids such as ___ handles and non-slip mats promote ___ during eating.",
        fillAnswers: ["thickened","independence"],
      },
    ],
  },
  ...
  "Prophylaxes": {
    ...
    questions: [
      ...
      {
        q: "What is aspiration prophylaxis and which measures does it include?",
        a: "Aspiration prophylaxis = protecting against inhalation of food or fluids. Measures: upright body position during eating, diet adaptation (thickening), small bites, slow eating, oral hygiene, swallowing monitoring, speech therapy for swallowing difficulties.",
        options: ["Exclusively gastric lavage and suctioning of airway secretions after aspiration has occurred","Upright position, adapted diet, small bites, slow eating, oral hygiene, speech therapy","Reducing gastric acid with antacids to prevent aspiration pneumonia from gastro-oesophageal reflux","Fast feeding and rapid switch to liquid diet; reduces the amount of food remaining in the mouth"],
        correct: 1,
        fillTemplate: "Aspiration prophylaxis: ___ position during eating, ___ diet and small bites.",
        fillAnswers: ["upright","adapted"],
      },
      {
        q: "What is constipation prophylaxis and which measures are effective?",
        a: "Constipation prophylaxis = prevention of constipation. Measures: adequate fluid intake (min. 1.5–2 l/day), high-fibre diet (fruit, vegetables, wholegrains), mobilisation, abdominal massage, regular toilet times, ensure privacy.",
        options: ["Daily laxatives as standard; non-pharmacological measures are rarely effective","Fluid intake, fibre-rich diet, mobilisation, abdominal massage, regular toilet times","Constipation is a normal ageing process; prophylactic measures are not evidence-based","Dietary measures only; exercise and abdominal massage have no proven effect on bowel motility"],
        correct: 1,
        fillTemplate: "Constipation prophylaxis: plenty of ___, fibre-rich diet and regular ___.",
        fillAnswers: ["fluids","mobilisation"],
      },
      {
        q: "What is intertrigo and how does its prophylaxis differ from pressure ulcer prevention?",
        a: "Intertrigo = inflammation in skin folds from friction and moisture (fungi, bacteria). Vulnerable areas: groin, anal fold, under breasts, between toes. Prophylaxis: keep skin folds dry daily, barrier cream or powder, skin inspection — no pressure-relief focus as with pressure ulcers.",
        options: ["Pressure-related skin redness over bony prominences; prophylaxis through repositioning like pressure ulcers","Skin fold inflammation from moisture; keep dry, barrier cream, daily inspection","Fungal infection of the oral mucosa only; prevented by antifungal mouthwash twice daily","Nail bed inflammation; prevented by regular nail trimming and daily foot baths"],
        correct: 1,
        fillTemplate: "Intertrigo develops in ___ from moisture. Prevention: keep dry and apply ___.",
        fillAnswers: ["skin folds","barrier cream"],
      },
      {
        q: "What is micro-positioning and how does it support pressure ulcer prevention?",
        a: "Micro-positioning = small position changes (5–30°) for pressure redistribution without full turning. Preferred position: 30° tilt. Complements standard 2-hourly repositioning. Combined with pressure-relieving aids. Document every position change.",
        options: ["Full turning from supine to prone every 2 hours; micro-positioning is not an accepted nursing method","Small position changes (5–30°); 30° tilt preferred; combined with pressure-relieving aids","Supine positioning only with a specialist mattress; lateral positioning increases pressure ulcer risk","Continuously adjusting the head of bed height; body position is irrelevant when a specialist mattress is used"],
        correct: 1,
        fillTemplate: "Micro-positioning involves position changes of ___°. The ___° tilt is the preferred position.",
        fillAnswers: ["5–30","30"],
      },
      {
        q: "What skin care products and methods are used in pressure ulcer prophylaxis?",
        a: "Regular skin inspection over bony prominences for redness. Dry skin: water-in-oil emollients. Moist skin (sweat, incontinence): barrier cream. No alcohol-based products. Rubbing or massaging reddened areas is contraindicated.",
        options: ["Alcohol-based lotion for skin over bony prominences; kills bacteria and toughens the skin surface","Skin inspection, water-in-oil emollient for dry skin, barrier cream for moisture; no rubbing reddened areas","Daily massage of all bony prominences with rubbing alcohol to stimulate local circulation","Any body lotion; the choice of product has no clinically relevant influence on pressure ulcer risk"],
        correct: 1,
        fillTemplate: "At-risk dry skin: use ___ emollient. Reddened areas over bony prominences must ___ be massaged.",
        fillAnswers: ["water-in-oil","not"],
      },
      {
        q: "What is contracture prophylaxis through positioning and which aids are used?",
        a: "Positioning goals: maintain joints in functional position, prevent drop foot and flexion deformities. Aids: positioning rolls, positioning cushions, drop foot orthosis, soft insoles for the palm. Passive movements complement positioning.",
        options: ["Position joints in maximum extension at all times; flexion is always prevented in bedridden patients","Maintain functional position; positioning rolls, cushions, drop foot orthosis, passive movements","Soft positioning only to reduce pain; joint alignment is secondary compared to resident comfort","Elevate all limbs on cushions; prevents oedema and contractures simultaneously"],
        correct: 1,
        fillTemplate: "Goal of contracture positioning: maintain joints in ___ position. Aids: ___ and positioning cushions.",
        fillAnswers: ["functional","positioning rolls"],
      },
      {
        q: "What is continence promotion and which measures help maintain bladder control?",
        a: "Continence promotion rather than simply managing incontinence. Measures: regular toilet offers (bladder training), voiding diary, adequate fluids (do not restrict!), pelvic floor exercises, barrier-free toilet access, ensure dignity and privacy.",
        options: ["Fluid restriction and daily in-out catheterisation; incontinence pads as the only measure","Regular toilet offers, voiding diary, pelvic floor exercises, adequate fluid intake","Incontinence is irreversible; prophylactic measures have no effect on bladder function","Indwelling catheter to prevent incontinence; prevents skin problems and simplifies care"],
        correct: 1,
        fillTemplate: "Continence promotion: regular ___ and adequate ___. Fluids should never be restricted.",
        fillAnswers: ["toilet offers","fluid intake"],
      },
    ],
  },
